...
現在の次フェーズは、[正式版統合計画](./official-integration-plan.md)に基づくv4 alpha準備である。過去の残作業候補は、[Phase 12後の全体棚卸し](./post-phase-12-inventory.md)と[Phase 12後の残作業](./phase-12/remaining-work.md)を参照する。
