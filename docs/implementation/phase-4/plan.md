...
Phase 4は、1つの詳細計画の中でサブフェーズを切って進める。実装中に範囲が膨らんだ場合は、必要に応じて `docs/implementation/phase-4/phase-4-x/` へ分割する。
...
- 仕様や方針の意味変更が必要になった場合は、`docs/spec/index.md` または `docs/spec/remake-policy.md` を更新する。
