...
| Phase 2-4: config / resolution / assets | `togostanza.config.ts`、旧設定検出、Sassの高度なmodule解決、`tsconfig.json`、共有ソース、asset解決を扱う。 | [007](../../../workbench/cases/007-config-and-resolution/) | [計画](./phase-2-4/plan.md) |
