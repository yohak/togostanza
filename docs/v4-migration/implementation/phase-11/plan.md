...
- Runtime edge semanticsを外部契約として固定する判断が出た場合は、`docs/v4-migration/spec/index.md` または `docs/v4-migration/spec/remake-policy.md` へ反映している。
- Runtime edge semanticsを固定しない、または判断を保留する場合は、`docs/v4-migration/investigation/follow-ups.md` または `docs/v4-migration/investigation/open-questions.md` へ戻している。
...
- `docs/v4-migration/implementation/phase-11/plan.md` の追加。
- `docs/v4-migration/implementation/index.md` へのPhase 11計画リンク追加。
...
- Phase 11完了後の `docs/v4-migration/implementation/phase-11/handoff.md`。
...
- 集約索引: `docs/v4-migration/implementation/phase-11/runtime-edge-semantics.md`。
- `this.params` と属性変換: 004。
- `renderTemplate()`、`handleAttributeChange()`、`importWebFontCSS()`、`menu()`、`query()`: 005。
- metadata異常系: 013。
- 実プロジェクト由来のruntime差分: 012。
- 外部契約として固定する挙動: `docs/v4-migration/spec/index.md` または `docs/v4-migration/spec/remake-policy.md`。
- 固定しない既知制約、改善候補、判断保留: `docs/v4-migration/investigation/follow-ups.md` または `docs/v4-migration/investigation/open-questions.md`。
...
- Phase 11内で修正する互換バグ。
- リメイク版仕様として `docs/v4-migration/spec/index.md` または `docs/v4-migration/spec/remake-policy.md` へ反映する外部契約。
- 実プロジェクト側の移行対象。
- リメイク版仕様として固定しない既知制約。
- `docs/v4-migration/investigation/follow-ups.md` または `docs/v4-migration/investigation/open-questions.md` へ戻す後続判断。
- Phase 12着手前に再実行する確認。
...
`docs/v4-migration/implementation/phase-11/runtime-edge-semantics.md` には、各runtime edgeの現行版根拠、リメイク版確認、固定する挙動、固定しない既知制約、再確認が必要な項目への索引をまとめる。詳細な観測ログは各workbench case READMEへ置き、索引は後続フェーズが拾うための入口にする。

Runtime edge semanticsの判断結果は、workbench READMEとPhase 11内の索引だけで閉じない。外部契約として固定するものは `docs/v4-migration/spec/index.md` または `docs/v4-migration/spec/remake-policy.md` へ反映し、固定しないものや判断保留は `docs/v4-migration/investigation/follow-ups.md` または `docs/v4-migration/investigation/open-questions.md` へ戻す。
...
- `docs/v4-migration/implementation/phase-11/plan.md`
- `docs/v4-migration/implementation/index.md` のPhase 11リンク更新
- 012 READMEのPhase 11観測結果
- `docs/v4-migration/implementation/phase-11/runtime-edge-semantics.md`
