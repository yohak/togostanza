...
- `docs/v4-migration/implementation/phase-10/plan.md` の追加。
- `docs/v4-migration/implementation/index.md` へのPhase 10 / Phase 11追加。
- 生成README本文の改善。
...
- `docs/v4-migration/implementation/phase-10/plan.md`
- `docs/v4-migration/implementation/index.md` のPhase 10 / Phase 11追記
- 生成README本文の更新
- package側test更新
- 001 READMEのPhase 10観測結果
- Phase 10完了後の `docs/v4-migration/implementation/phase-10/handoff.md`
