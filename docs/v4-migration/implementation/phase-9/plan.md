...
- `docs/v4-migration/implementation/phase-9/plan.md` の追加。
- `docs/v4-migration/implementation/index.md` へのPhase 9追加。
...
- `docs/v4-migration/implementation/phase-9/plan.md`
- `docs/v4-migration/implementation/index.md` のPhase 9追加
- 012 READMEのPhase 9観測結果
- referencesローカル再現手順
- 必要に応じたpackage側test helperまたは確認スクリプト
- Phase 9完了後の `docs/v4-migration/implementation/phase-9/handoff.md`
